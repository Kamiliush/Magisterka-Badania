...
fps_data <- data.frame(
  Base = read.csv(file = './dane/rdr2/base.csv', sep = ';')$Framerate,
  DLSS_Quality = read.csv(file = './dane/rdr2/dlss-jakosc.csv', sep = ';')$Framerate,
  DLSS_Balance = read.csv(file = './dane/rdr2/dlss-balans.csv', sep = ';')$Framerate,
  DLSS_Performance = read.csv(file = './dane/rdr2/dlss-wydajnosc.csv', sep = ';')$Framerate,
  FSR_Quality = read.csv(file = './dane/rdr2/fsr-jakosc.csv', sep = ';')$Framerate,
  FSR_Balance = read.csv(file = './dane/rdr2/fsr-balans.csv', sep = ';')$Framerate,
  FSR_Performance = read.csv(file = './dane/rdr2/fsr-wydajnosc.csv', sep = ';')$Framerate
)
