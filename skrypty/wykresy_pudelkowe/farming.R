...
fps_data <- data.frame(
  Base = read.csv(file = './dane/farming-simulator/bazowy.csv', sep = ';')$Framerate,
  DLSS_Quality = read.csv(file = './dane/farming-simulator/dlss-jakosc.csv', sep = ';')$Framerate,
  DLSS_Balance = read.csv(file = './dane/farming-simulator/dlss-balans.csv', sep = ';')$Framerate,
  DLSS_Performance = read.csv(file = './dane/farming-simulator/dlss-wydajnosc.csv', sep = ';')$Framerate,
  FSR_Quality = read.csv(file = './dane/farming-simulator/fsr-jakosc.csv', sep = ';')$Framerate,
  FSR_Balance = read.csv(file = './dane/farming-simulator/fsr-balans.csv', sep = ';')$Framerate,
  FSR_Performance = read.csv(file = './dane/farming-simulator/fsr-wydajnosc.csv', sep = ';')$Framerate
)
