...
fps_data <- data.frame(
  Base = read.csv(file = './dane/forza/bazowy.csv', sep = ';')$Framerate,
  DLSS_Quality = read.csv(file = './dane/forza/dlss-jakosc.csv', sep = ';')$Framerate,
  DLSS_Balance = read.csv(file = './dane/forza/dlss-balans.csv', sep = ';')$Framerate,
  DLSS_Performance = read.csv(file = './dane/forza/dlss-wydajnosc.csv', sep = ';')$Framerate,
  FSR_Quality = read.csv(file = './dane/forza/fsr-jakosc.csv', sep = ';')$Framerate,
  FSR_Balance = read.csv(file = './dane/forza/fsr-balans.csv', sep = ';')$Framerate,
  FSR_Performance = read.csv(file = './dane/forza/fsr-wydajnosc.csv', sep = ';')$Framerate
)
