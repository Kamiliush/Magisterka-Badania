...
fps_data <- data.frame(
  Base = read.csv(file = './dane/chernobylite/bazowy.csv', sep = ';')$Framerate,
  DLSS_Quality = read.csv(file = './dane/chernobylite/dlss-jakosc.csv', sep = ';')$Framerate,
  DLSS_Balance = read.csv(file = './dane/chernobylite/dlss-balans.csv', sep = ';')$Framerate,
  DLSS_Performance = read.csv(file = './dane/chernobylite/dlss-wydajnosc.csv', sep = ';')$Framerate,
  FSR_Quality = read.csv(file = './dane/chernobylite/fsr-jakosc.csv', sep = ';')$Framerate,
  FSR_Balance = read.csv(file = './dane/chernobylite/fsr-balans.csv', sep = ';')$Framerate,
  FSR_Performance = read.csv(file = './dane/chernobylite/fsr-wydajnosc.csv', sep = ';')$Framerate
)
